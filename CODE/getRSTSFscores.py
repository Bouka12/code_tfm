...
path = "C:/Users/BOUKA/OneDrive/Bureau/CODE/tsml_eval/RSTSF-Resample0/RSTSF/Predictions/"
...
for dataset_name, data in datasets_dict.items():
    ...
    for metric in metrics:
        RSTSF_results[dataset_name][metric] = evaluate_metric(y_test, y_pred, y_proba, metric,cr)


# Convert dictionary to DataFrame
df = pd.DataFrame.from_dict(RSTSF_results, orient='index')
...
#  save as Excel
df.to_excel('RSTSF_results.xlsx', index=False)
