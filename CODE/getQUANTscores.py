...
def evaluate_metric(y_true, y_pred, y_preds_proba, metric, cr):
    """
...
path = "C:/Users/BOUKA/OneDrive/Bureau/CODE/tsml_eval/QUANT-Resample0/QUANTClassifier/Predictions/"
...
for dataset_name, data in datasets_dict.items():
    ...
    for metric in metrics:
        Quant_results[dataset_name][metric] = evaluate_metric(y_test, y_pred, y_proba, metric,cr)


# Convert dictionary to DataFrame
df = pd.DataFrame.from_dict(Quant_results, orient='index')
...
#  save as Excel
df.to_excel('Quant_results.xlsx', index=False)
